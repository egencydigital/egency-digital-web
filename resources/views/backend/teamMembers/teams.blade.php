    ...
    <div class="min-h-screen bg-white p-8">
        ...
        <div class="max-w-7xl mx-auto">
            <div class="flex justify-between align-middle text-center my-4">
                <h1 class="text-3xl font-bold text-black mb-6">Team Members</h1>
                            ...
                            <tr class="border-b border-slate-700">
                                ...
                                <td>
                                    @if ($member->socialLinks)
                                        @foreach ($member->socialLinks as $platform => $link)
                                            @if ($link)
                                                <a href="{{ $link }}" target="_blank"
                                                    class="text-blue-400 hover:underline text-xs block">
                                                    {{ ucfirst($platform) }}
                                                </a>
                                            @endif
                                        @endforeach
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#teamTable').on('click', '.edit-btn', function() {
                ...
                window.location.href = '/addMember/' + memberId; // Adjust route if different
            });
