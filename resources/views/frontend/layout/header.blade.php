    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="flex items-center justify-between h-20">
            ...
            <div class="group flex items-center cursor-pointer">
                ...
                <span
                    class="font-semibold text-lg tracking-tight text-gray-900
                    ...
                    <div class="relative" @mouseenter="activeMega = 'industries'" @mouseleave="activeMega = null">
                        ...
                        <button class="flex items-center gap-1 hover:text-[#E50913] transition-colors duration-300">
                            ...
                            <svg class="w-4 h-4 transition-transform duration-300"
                                :class="{ 'rotate-90': activeMega === 'industries' }" viewBox="0 0 24 24"
                        ...
                        <div x-show="activeMega === 'industries'" x-transition:enter="transition ease-out duration-300"
                            ...
                            class="fixed left-0 top-20 w-full bg-white border-t border-gray-200 shadow-xl z-50">
            ...
            <div class="hidden lg:flex items-center gap-4">
                <a href="https://wa.me/+923250525254" target="_blank" class="bg-[#E50913] text-white px-6 py-2.5 rounded-full hover:bg-[#E50913] flex align-middle gap-2">
                ...
                <a href="mailto:Info@egencydigital.com"
                    class="flex align-middle gap-2 border border-[#E50913] text-[#E50913] px-6 py-2.5 rounded-full hover:bg-[#E50913]/10">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 12H8m8-4H8m8 8H8m14 0a2 2 0 01-2 2H6a2 2 0 01-2-2V6a2 2 0 012-2h12a2 2 0 012 2v12z"></path>
                        </svg>
                        Email Us
                </a>
            </div>
